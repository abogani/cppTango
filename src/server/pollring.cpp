...
void PollRing::get_cmd_history(long n, Tango::DevCmdHistory_4 *ptr, Tango::CmdArgType &cmd_type)
{
    ...
    if((cmd_type <= DEV_STRING) || (cmd_type == DEV_STATE) || (cmd_type == CONST_DEV_STRING) ||
       (cmd_type == DEV_UCHAR) || (cmd_type == DEV_LONG64) || (cmd_type == DEV_ULONG64) || (cmd_type == DEV_ENCODED))
    {
        for(i = 0; i < n; i++)
        {
            if(ring[index].except != nullptr)
        ...
        if(ring[index].except == nullptr)
        {
            ...
            if((*ptr)[seq_index].value.quality != Tango::ATTR_INVALID)
            {
                ...
                case Tango::DEV_ENUM:
                    ...
                    new_tmp_sh = new DevVarShortArray(
                        tmp_sh->length(), tmp_sh->length(), const_cast<short *>(tmp_sh->get_buffer()), false);
                ...
                case Tango::DEV_DOUBLE:
                    ...
                    new_tmp_db = new DevVarDoubleArray(
                        tmp_db->length(), tmp_db->length(), const_cast<double *>(tmp_db->get_buffer()), false);
                ...
                case Tango::DEV_LONG:
                    ...
                    new_tmp_lg = new DevVarLongArray(
                        tmp_lg->length(), tmp_lg->length(), const_cast<DevLong *>(tmp_lg->get_buffer()), false);
                ...
                case Tango::DEV_LONG64:
                    ...
                    new_tmp_lg64 = new DevVarLong64Array(
                        tmp_lg64->length(), tmp_lg64->length(), const_cast<DevLong64 *>(tmp_lg64->get_buffer()), false);
                ...
                case Tango::DEV_STRING:
                    ...
                    new_tmp_str = new DevVarStringArray(
                        tmp_str->length(), tmp_str->length(), const_cast<char **>(tmp_str->get_buffer()), false);
                ...
                case Tango::DEV_FLOAT:
                    ...
                    new_tmp_fl = new DevVarFloatArray(
                        tmp_fl->length(), tmp_fl->length(), const_cast<float *>(tmp_fl->get_buffer()), false);
                ...
                case Tango::DEV_BOOLEAN:
                    ...
                    new_tmp_boo = new DevVarBooleanArray(
                        tmp_boo->length(), tmp_boo->length(), const_cast<DevBoolean *>(tmp_boo->get_buffer()), false);
                ...
                case Tango::DEV_USHORT:
                    ...
                    new_tmp_ush = new DevVarUShortArray(
                        tmp_ush->length(), tmp_ush->length(), const_cast<DevUShort *>(tmp_ush->get_buffer()), false);
                ...
                case Tango::DEV_UCHAR:
                    ...
                    new_tmp_uch = new DevVarCharArray(
                        tmp_uch->length(), tmp_uch->length(), const_cast<DevUChar *>(tmp_uch->get_buffer()), false);
                ...
                case Tango::DEV_ULONG:
                    ...
                    new_tmp_ulg = new DevVarULongArray(
                        tmp_ulg->length(), tmp_ulg->length(), const_cast<DevULong *>(tmp_ulg->get_buffer()), false);
                    (*ptr)[seq_index].value.value <<= new_tmp_ulg;
                    break;

                case Tango::DEV_ULONG64:
                    (*ring[index].attr_value)[0].value >>= tmp_ulg64;
                    new_tmp_ulg64 = new DevVarULong64Array(tmp_ulg64->length(),
                                                           tmp_ulg64->length(),
                                                           const_cast<DevULong64 *>(tmp_ulg64->get_buffer()),
                                                           false);
