...
class GroupElementFactory
{
  ...
  private:
    ...
    static DeviceNames
        resolve_remote_device_names(int db_port, std::string &db_host, std::string &name_or_pattern_without_host);
...
class Group : public GroupElement
{
  ...
  public:
     ...
     * Therefore, never try to delete a Group (respectively a DeviceProxy) returned by a call to @e
     ...
     *
     * The pattern parameter can be a group name, a device name or a device name pattern (e.g domain_*
     /family/member_*).
     ...
     * (Chapter 4.7.3.1 in <a href=http://www.esrf.eu/computing/cs/tango/tango_doc/kernel_doc/ds_prog/index.html
     * target=new>Tango book</a>). See also Case 1 of executing a command (Chapter 4.7.3.2 in <a
     * href=http://www.esrf.eu/computing/cs/tango/tango_doc/kernel_doc/ds_prog/index.html target=new>Tango book</a>) for
     * an example.
     *
     ...
     * (Chapter 4.7.3.1 in <a href=http://www.esrf.eu/computing/cs/tango/tango_doc/kernel_doc/ds_prog/index.html
     * target=new>Tango book</a>) for details. See also Case 2 of executing a command (Chapter 4.7.3.4 in <a
     * href=http://www.esrf.eu/computing/cs/tango/tango_doc/kernel_doc/ds_prog/index.html target=new>Tango book</a>) for
     * an example.
     *
     * @param [in] c The command name
     ...
     * The std::vector d contains a specific argument value for each device in the group. Its size must equal
     * Group::get_size(fwd). Otherwise, an exception is thrown. The order of the argument values must follows the order
     * of the devices in the group (d[0] => 1st device, d[1] => 2nd device and so on). If fwd is set to true (the
     * default), the request is also forwarded to subgroups. Otherwise, it is only applied to the local set of devices.
    ...
    /**
     * Executes a Tango command with different input data (using DeviceData object) on each device in the group
     * asynchronously.
     *
     ...
     * The std::vector d contains a specific argument value for each device in the group. Its size must equal
     * Group::get_size(fwd). Otherwise, an exception is thrown. The order of the argument values must follows the order
     * of the devices in the group (d[0] => 1st device, d[1] => 2nd device and so on). The parameter fgt is a fire and
     * forget flag. If set to true, it means that no reply is expected (i.e. the caller does not care about it and will
     * not even try to get it). A false default value is provided. If fwd is set to true (the default), the request is
     * also forwarded to subgroups. Otherwise, it is only applied to the local set of devices. See Case 3 of Executing a
     * command (Chapter 4.7.3.5 in <a href=http://www.esrf.eu/computing/cs/tango/tango_doc/kernel_doc/ds_prog/index.html
     * target=new>Tango book</a>) for an example of this special form of command_inout.
     *
     * @param [in] c The command name
     * @param [in] d The command input data
     * @param [in] fgt The command data
     ...
     */
    long
        command_inout_asynch(const std::string &c, const std::vector<DeviceData> &d, bool fgt = false, bool fwd = true);
    /**
     ...
     * knowledge of the devices order in the group.
     * The parameter c is the name of the command.
     * The std::vector d contains a specific argument value for each device in the group. Since it's a template data
     * type, d is able to contain any Tango command argument type. Its size must equal Group::get_size(fwd). Otherwise,
     * an exception is thrown. The order of the argument values must follows the order of the devices in the group (d[0]
     * => 1st device, d[1] => 2nd device and so on). The parameter fgt is a fire and forget flag. If set to true, it
     * means that no reply is expected (i.e. the caller does not care about it and will not even try to get it). A false
     * default value is provided. If fwd is set to true (the default), the request is also forwarded to subgroups.
     * Otherwise, it is only applied to the local set of devices. See Case 3 of Executing a command (Chapter 4.7.3.5 in
     * <a href=http://www.esrf.eu/computing/cs/tango/tango_doc/kernel_doc/ds_prog/index.html target=new>Tango book</a>)
     * for an example of this special form of command_inout.
     *
     * @tparam T The command input data type
     ...
     * <a href=http://www.esrf.eu/computing/cs/tango/tango_doc/kernel_doc/ds_prog/index.html target=new>Tango book</a>)
     * for details. See also Reading an attribute (Chapter 4.7.4 in <a
     * href=http://www.esrf.eu/computing/cs/tango/tango_doc/kernel_doc/ds_prog/index.html target=new>Tango book</a>) for
     * an example.
     *
     ...
     *
     * Reads several attributes on each device in the group. This method is synchronous and does not return until
     * replies are obtained or timeouts occurred. The parameter al is the list of attributes to be read. If fwd is set
     * to true (the default) request is forwarded to subgroups. Otherwise, it is only applied to the local set of
     * devices. Attribute values are returned in a GroupAttrReplyList. See Obtaining attribute values (Chapter 4.7.4.1
     * in <a href=http://www.esrf.eu/computing/cs/tango/tango_doc/kernel_doc/ds_prog/index.html target=new>Tango
     * book</a>) for details. See also Reading an attribute (Chapter 4.7.4 in <a
     * href=http://www.esrf.eu/computing/cs/tango/tango_doc/kernel_doc/ds_prog/index.html target=new>Tango book</a>) for
     * an example.
     *
     ...
     * a near future.
     * See Reading an attribute (Chapter 4.7.4 in <a
     * href=http://www.esrf.eu/computing/cs/tango/tango_doc/kernel_doc/ds_prog/index.html target=new>Tango book</a>) for
     * an example.
     *
     * @param [in] a The attribute name
     ...
     * <a href=http://www.esrf.eu/computing/cs/tango/tango_doc/kernel_doc/ds_prog/index.html target=new>Tango book</a>)
     * for details. See also Case 1 of Writing an attribute (Chapter 4.7.5.2 in <a
     * href=http://www.esrf.eu/computing/cs/tango/tango_doc/kernel_doc/ds_prog/index.html target=new>Tango book</a>) for
     * an example.
     *
     ...
     * acknowledgements are obtained or timeouts occurred.
     * The first parameter d is a vector of Tango generic container for attribute carrying both the attribute name and
     * the value. See the Tango::DeviceAttribute documentation for details. If fwd is set to true (the default) request
     * is forwarded to subgroups. Otherwise, it is only applied to the local set of devices. Acknowledgements are
     * returned in a GroupReplyList. See Obtaining acknowledgements (Chapter 4.7.5.1 in <a
     * href=http://www.esrf.eu/computing/cs/tango/tango_doc/kernel_doc/ds_prog/index.html target=new>Tango book</a>) for
     ...
     * Acknowledgements are returned in a GroupReplyList. See Obtaining acknowledgements (Chapter 4.7.5.1 in
     * <a href=http://www.esrf.eu/computing/cs/tango/tango_doc/kernel_doc/ds_prog/index.html target=new>Tango book</a>)
     * for details. See also Case 2 of Writing an attribute (Chapter 4.7.5.3 in <a
     * href=http://www.esrf.eu/computing/cs/tango/tango_doc/kernel_doc/ds_prog/index.html target=new>Tango book</a>) for
     * an example.
     *
     ...
     * The first parameter d is a vector of Tango generic container for attribute carrying both the attribute name and
     * the value. See the Tango::DeviceAttribute documentation for details. If fwd is set to true (the default) request
     * is forwarded to subgroups. Otherwise, it is only applied to the local set of devices. See Case 1 of Writing an
     ...
     * If fwd is set to true (the default) request is forwarded to subgroups. Otherwise, it is only applied to the
     * local set of devices.
     * See Case2 of Writing an attribute (Chapter 4.7.5.3 in <a
     * href=http://www.esrf.eu/computing/cs/tango/tango_doc/kernel_doc/ds_prog/index.html target=new>Tango book</a>) for
     * an example.
     *
     * @tparam T The attribute data type
