...
class NamedDevFailedList : public Tango::DevFailed
{
  public:
    ...
    std::vector<NamedDevFailed>
        err_list; ///< There is one element in this vector for each attribute which failed during its writing.
      ...
      public:                                                                                                          \
        ...
        {                                                                                                              \
            ...
            throw Tango::E(errors);                                                                                    \
                                                                                                                       ...
                                                                                                                       \
        static inline void re_throw_exception(                                                                         \
            Tango::E &ex, const char *reason, char *desc, const char *origin, Tango::ErrSeverity sever = Tango::ERR)   \
        {                                                                                                              \
...
#define TRANSIENT_NOT_EXIST_EXCEPT_CMD(E)                                                                         \
    ...
    {                                                                                                             \
        ...
        {                                                                                                         \
            ...
            ApiCommExcept::re_throw_exception(                                                                    \
                E, (const char *) API_DeviceTimedOut, desc.str(), (const char *) "Connection::command_inout()");  \
        }                                                                                                         \
    }                                                                                                             \
                                                                                                                  \
    ...
    {                                                                                                             \
        set_lock_ctr(0);                                                                                          \
        TangoSys_OMemStream desc;                                                                                 \
        desc << "Device " << dev_name() << " has lost your lock(s) (server re-start?) while executing command "   \
             << command << std::ends;                                                                             \
        DeviceUnlockedExcept::re_throw_exception(                                                                 \
            E, (const char *) DEVICE_UNLOCKED_REASON, desc.str(), (const char *) "Connection::command_inout()");  \
    }                                                                                                             \
    ctr++;                                                                                                        \
                                                                                                                  \
