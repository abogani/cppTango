...
//@{
     ...
     * on how to extract data from a WPipe
     *
    ...
    {
        return the_blob.get_data_elt_names();
    }
    ...
    {
        return the_blob.get_data_elt_name(ind);
    }
    ...
    {
        return the_blob.get_data_elt_type(ind);
    }
