...
class EncodedAttribute
{
  public:
     ...
     *
     */
    void encode_gray8(const unsigned char *gray8, int width, int height);
     ...
     *
     */
    void encode_rgb24(const unsigned char *rgb24, int width, int height);
    //@}
  ...
  private:
    ...
    // the caller.
    // ----------------------------------------------------------------------------
    void jpeg_decode(std::size_t jpegSize, unsigned char *jpegData, int *width, int *height, unsigned char *&frame);
};
