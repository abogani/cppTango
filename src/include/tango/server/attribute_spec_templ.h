...
// 2 - A file with template method definition (attribute_templ.h for Attribute class)
// 3 - A file with template specialization defnition (attribute_spec_templ.h (this file))
//
