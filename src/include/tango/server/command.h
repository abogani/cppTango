...
class Command
{
  public:
     ...
     */
    void set_in_type_desc(std::string desc)
    {
        in_type_desc = desc;
    }
     ...
     */
    void set_out_type_desc(std::string desc)
    {
        out_type_desc = desc;
    }
...
//--------------------------------------------------------------------------
template <typename INARG, typename OUTARG>
TemplCommandInOut<INARG, OUTARG>::TemplCommandInOut(const std::string &s,
...
template <typename INARG>
TemplCommandIn<INARG>::TemplCommandIn(const std::string &s,
...
template <typename OUTARG>
TemplCommandOut<OUTARG>::TemplCommandOut(const std::string &s,
                                         OUTARG (DeviceImpl::*f)(),
                                         bool (DeviceImpl::*a)(const CORBA::Any &),
                                         Tango::DispLevel level) :
    TemplCommand(s, level),
