...
class DeviceClass
{
  ...
  public:
    ...
    virtual void device_name_factory(std::vector<std::string> &list)
    {
        (void) list;
    }
     ...
     */
    std::vector<DeviceImpl *> &get_device_list()
    {
        return device_list;
    }
     ...
     */
    void set_type(const std::string &dev_type)
    {
        type = dev_type;
    }
...
//@{
     ...
     * handler is written. A default false value is provided * @exception DevFailed Thrown if the signal number is out
     * of range or if the operating system failed to register a signal for the process. Click <a
     * href="https://tango-controls.readthedocs.io/en/latest/development/advanced/IDL.html#exceptions">here</a> to read
  ...
  public:
    /// @privatesection
    std::vector<std::string> &get_nodb_name_list()
    {
    ...
    std::vector<std::string> &get_wiz_class_prop()
    {
        return wiz_class_prop;
    }

    std::vector<std::string> &get_wiz_dev_prop()
    {
        return wiz_dev_prop;
    }

    std::string &get_cvs_tag()
    {
        return cvs_tag;
    }

    std::string &get_cvs_location()
    {
        return cvs_location;
    }

    std::string &get_svn_tag()
    {
        return svn_tag;
    }

    std::string &get_svn_location()
    {
        return svn_location;
    }

    void set_cvs_tag(const std::string &str)
    {
        cvs_tag = str;
    }

    void set_cvs_location(const std::string &str)
    {
        cvs_location = str;
    }

    void add_device(DeviceImpl *dev)
    {
    ...
    bool get_device_factory_done()
    {
        return device_factory_done;
    }

    void set_device_factory_done(bool val)
    {
        device_factory_done = val;
    }
