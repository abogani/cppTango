...
class EventSupplier
{
  public:
    ...
    SendEventType detect_and_push_events(
        DeviceImpl *, struct SuppliedEventData &, DevFailed *, std::string &, PollClock::time_point);

    //------------------ Change event ---------------------------

    bool detect_change(
        Attribute &, struct SuppliedEventData &, bool, double &, double &, DevFailed *, bool &, DeviceImpl *);
    ...
    bool detect_and_push_alarm_event(
        DeviceImpl *, struct SuppliedEventData &, Attribute &, std::string &, DevFailed *, bool user_push = false);
    bool do_detect_and_push_alarm_event(
        DeviceImpl *, struct SuppliedEventData &, Attribute &, std::string &, DevFailed *, bool user_push = false);
    ...
    bool detect_and_push_periodic_event(
        DeviceImpl *, struct SuppliedEventData &, Attribute &, std::string &, DevFailed *, PollClock::time_point);
    ...
    omni_condition &get_push_cond()
    {
        return push_cond;
    }

    static omni_mutex &get_event_mutex()
    {
        return event_mutex;
    }

    std::string &get_fqdn_prefix()
    {
        return fqdn_prefix;
    }
    ...
    bool get_one_subscription_cmd()
    {
        return one_subscription_cmd;
    }

    void set_one_subscription_cmd(bool val)
    {
        one_subscription_cmd = val;
    }
