...
void DevTestClass::command_factory()
{
    command_list.push_back(
        new IOString("IOString", Tango::DEV_STRING, Tango::DEV_STRING, "Word", "the pallindrome is"));
    ...
    command_list.push_back(new IOBooleanArray(
        "IOBoolArray", Tango::DEVVAR_BOOLEANARRAY, Tango::DEVVAR_BOOLEANARRAY, "Array of boolean", "Echo"));
    command_list.push_back(new IOCharArray(
        "IOCharArray", Tango::DEVVAR_CHARARRAY, Tango::DEVVAR_CHARARRAY, "Array of char", "This reversed array"));
    command_list.push_back(new IOShortArray(
        "IOShortArray", Tango::DEVVAR_SHORTARRAY, Tango::DEVVAR_SHORTARRAY, "Array of short", "This array * 2"));
    command_list.push_back(new IOLongArray(
        "IOLongArray", Tango::DEVVAR_LONGARRAY, Tango::DEVVAR_LONGARRAY, "Array of long", "This array * 2"));
    command_list.push_back(new IOFloatArray(
        "IOFloatArray", Tango::DEVVAR_FLOATARRAY, Tango::DEVVAR_FLOATARRAY, "Array of float", "This array * 2"));
    command_list.push_back(new IODoubleArray(
        "IODoubleArray", Tango::DEVVAR_DOUBLEARRAY, Tango::DEVVAR_DOUBLEARRAY, "Array of double", "This array * 2"));
    ...
    command_list.push_back(
        new IORegClassSig("IORegClassSig", Tango::DEV_LONG, Tango::DEV_VOID, "Signal number", "void"));
    command_list.push_back(
    ...
    command_list.push_back(new IODevListByClass(
        "IODevListByClass", Tango::DEV_STRING, Tango::DEV_STRING, "class name", "class first device name"));
    command_list.push_back(new IODevByName(
        "IODevByName", Tango::DEV_STRING, Tango::DEV_STRING, "device name", "device name (returned by name()"));
    command_list.push_back(
    ...
    command_list.push_back(new IOSeqVecChar(
        "IOSeqVecChar", Tango::DEVVAR_CHARARRAY, Tango::DEVVAR_CHARARRAY, "Input char array", "Output char array"));
    command_list.push_back(new IOSeqVecShort("IOSeqVecShort",
                                             Tango::DEVVAR_SHORTARRAY,
                                             Tango::DEVVAR_SHORTARRAY,
                                             "Input short array",
                                             "Output short array"));
    command_list.push_back(new IOSeqVecLong(
        "IOSeqVecLong", Tango::DEVVAR_LONGARRAY, Tango::DEVVAR_LONGARRAY, "Input long array", "Output long array"));
    ...
    command_list.push_back(new IOAttrTrigPoll(
        "IOAttrTrigPoll", Tango::DEV_STRING, Tango::DEV_VOID, "Attribute's name to trig polling", "void"));
    command_list.push_back(new IOInitWAttr("IOInitWAttr", Tango::DEV_VOID, Tango::DEV_VOID, "void", "void"));
    command_list.push_back(new IOInitRWAttr("IOInitRWAttr", Tango::DEV_VOID, Tango::DEV_VOID, "void", "void"));
    ...
    command_list.push_back(new IOChangeQuality(
        "IOChangeQuality", Tango::DEV_SHORT, Tango::DEV_VOID, "0->VALID, 1->INVALID, 2->ALARM, 3->CHANGING", "void"));
    ...
    command_list.push_back(new IOGetCbExecuted(
        "IOGetCbExecuted", Tango::DEV_VOID, Tango::DEV_LONG, "void", "Number of times the CB has been executed"));
    command_list.push_back(
    ...
    command_list.push_back(new OLongString(
        "OLongString", Tango::DEV_VOID, Tango::DEVVAR_LONGSTRINGARRAY, "void", "A unsigned long and string array"));
    ...
    command_list.push_back(
        new ChangeEncodedData("ChangeEncodedData", Tango::DEV_VOID, Tango::DEV_VOID, "void", "void"));
    ...
    command_list.push_back(new IOEncoded(
        "IOEncoded", Tango::DEV_ENCODED, Tango::DEV_ENCODED, "DevEncoded structure", "DevEncoded structure"));
    command_list.push_back(new OEncoded(
        "OEncoded", Tango::DEV_VOID, Tango::DEV_ENCODED, "void", "DevEncoded structure to test polling/history"));
    command_list.push_back(new PollingPoolTst(
        "PollingPoolTst", Tango::DEV_VOID, Tango::DEVVAR_STRINGARRAY, "void", "Polling threads pool configuration"));
    ...
    command_list.push_back(new PollingInDeviceTst(
        "IOPollingInDevice", Tango::DEV_VOID, Tango::DEVVAR_STRINGARRAY, "void", "Polling in device test outputs"));
    command_list.push_back(
    ...
    command_list.push_back(new WriteAttrHardwareThrow("WriteAttrHardwareThrow",
                                                      ...
                                                      "void"));
    command_list.push_back(new IOAddCommand(
        "IOAddCommand", Tango::DEV_LONG, Tango::DEV_VOID, "True if command must be added at device level", "void"));
    ...
    command_list.push_back(new ForbiddenEnumValue(
        "ForbiddenEnumValue", Tango::DEV_SHORT, Tango::DEV_VOID, "New value for setting enum (Must be > 100)", "void"));
    ...
    command_list.push_back(
        new Tango::TemplCommandIn<Tango::DevLong>((const char *) "IOTemplInState",
    ...
    command_list.push_back(
        new Tango::TemplCommandOut<Tango::DevVarLongArray *>((const char *) "IOTemplOutState",
    ...
    command_list.push_back(new Tango::TemplCommandInOut<Tango::DevDouble, Tango::DevVarDoubleArray *>(
        (const char *) "IOTemplInOutState",
        static_cast<Tango::DbA_CmdMethPtr_Db>(&DevTest::IOTemplInOut),
        static_cast<Tango::StateMethPtr>(&DevTest::templ_state)));

    command_list.push_back(
        new GetEnumWriteValue("GetEnumWriteValue", Tango::DEV_VOID, Tango::DEV_SHORT, "void", "short"));
}
...
void DevTestClass::signal_handler(long signo)
{
    ...
    TANGO_LOG_INFO << "[Class signal handler] received signal number " << signo << " for class " << name << std::endl;
}
