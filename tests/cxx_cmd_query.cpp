...
class CmdQueryTestSuite : public CxxTest::TestSuite
{
  ...
  public:
    ...
    //        TEST_LOG << "name: " << cmd_inf.cmd_name << " tag: " << cmd_inf.cmd_tag << " displ_level: " <<
    //        cmd_inf.disp_level << " in_type: " << cmd_inf.in_type << " type_desc: " << cmd_inf.in_type_desc << "
    //        out_type: " << cmd_inf.out_type << " out_type_desc: " << cmd_inf.out_type_desc << endl;
    //    }
    ...
    {
        TS_ASSERT_THROWS_ASSERT(device1->command_query("DevToto"),
                                Tango::DevFailed & e,
    ...
    void test_command_list_query_AddObjPolling(void)
    {
        ...
        TS_ASSERT_EQUALS(cmd_inf.out_type, Tango::DEV_VOID);
        TS_ASSERT_EQUALS(cmd_inf.in_type_desc,
    ...
    void test_command_list_query_ZMQEventSubscriptionChange(void)
    {
        ...
        TS_ASSERT_EQUALS(
            ...
            "endpoints.");
        TS_ASSERT_EQUALS(cmd_inf.out_type_desc,
