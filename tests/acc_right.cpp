...
int main(int argc, char **argv)
{
    ...
    TEST_LOG << "  Access allowed/blocked for forth config (* READ, user defined with default device WRITE, cmd line "
                "device READ) --> OK"
             << endl;
    ...
    TEST_LOG << "  Access allowed/blocked for fifth config (cmd line device WRITE + allowed from wrong address) --> OK"
             << endl;
    ...
    TEST_LOG << "  Access allowed/blocked for sixth config (cmd line device WRITE + allowed from user address) --> OK"
             << endl;
    ...
    TEST_LOG << "  Read access if access service defined in DB but is not running (even for allowed commands) --> OK"
             << endl;
    ...
    try
    {
        ...
        ca_pid = start_ds("/home/taurel/tango/cppserver/TangoAccessControl/bin/ubuntu810/TangoAccessControl",
                          "TangoAccessControl",
                          "1");
